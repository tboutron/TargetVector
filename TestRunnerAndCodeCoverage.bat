...
"C:\Program Files\OpenCppCoverage\OpenCppCoverage.exe" --sources=%workspace%\Source --modules %workspace% --excluded_sources=\Tests --export_type=cobertura:%testReportFolder&\%codeCoverageFile%  -- %testRunnerCommand%
